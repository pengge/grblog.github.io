# 💡收集PDF处理、机器人、插件、文案、影视、音乐、插画等众多资源的集合

## [](#📕-PDF处理工具推荐 "📕 PDF处理工具推荐")📕 PDF处理工具推荐
...
| 微信助手 | [项目](https://github.com/sfyc23/EverydayWechat) | 1.每日定时给好友（女友）发送定制消息2.机器人自动回复好友3.群助手功能（例如：查询垃圾分类、天气、日历、电影实时票房、快递物流、PM2.5等） |  |
...
| 3\. 弹力球 | [https://bouncyballs.org/](https://bouncyballs.org/) | 可以选择球的外观——塑料、气泡、表情符号或眼球，会根据麦克风（和声音）和鼠标的点击来进行跳动，可以播放一段音乐，会发生变化 |  |
| 4\. Patatap | [https://www.patatap.com/](https://www.patatap.com/) | 敲击键盘，就会通过声音和简短的动画，按空格切换背景和模式 |  |
| 5\. Pixel Thoughts | [https://www.pixelthoughts.co/#](https://www.pixelthoughts.co/#) | 把你的压力写上去，网站可以带你进行 60 秒的冥想课程，为您提供最佳体验 |  |
| 6.A Soft Murmur | [https://asoftmurmur.com/](https://asoftmurmur.com/) | 使用该网站来创建令人敬畏且富有成效的环境噪音 |  |
| 7\. 找到隐藏的牛 | [https://findtheinvisiblecow.com/](https://findtheinvisiblecow.com/) | 移动你的鼠标直到你找到了隐藏的牛，你鼠标离得越近，它叫的越响 |  |
| 8\. 创造你的沙画 | [https://thisissand.com/](https://thisissand.com/) | 在电脑屏幕前创造一幅沙画 |  |

* * *

## [](#🥨-高质量文案素材网站 "🥨 高质量文案素材网站")🥨 高质量文案素材网站
...
## [](#🌐-Chrome谷歌浏览器 "🌐 Chrome谷歌浏览器")🌐 Chrome谷歌浏览器
...
## [](#🥅-检测网页变动通知提醒服务 "🥅 检测网页变动通知提醒服务")🥅 检测网页变动通知提醒服务
...
[https://xn--flw351e.ml/](https://谷歌.ml/)  
...
## [](#🎞-通过台词搜索下载相应的电影片段 "🎞 通过台词搜索下载相应的电影片段")🎞 通过台词搜索下载相应的电影片段
...
## [](#🕹-上班摸鱼有趣小游戏大全 "🕹 上班摸鱼有趣小游戏大全")🕹 上班摸鱼有趣小游戏大全
...
## [](#🧲免费矢量插画下载网站 "🧲免费矢量插画下载网站:")🧲免费矢量插画下载网站:
...
## [](#📝-论文、语法、写作、英语等纠错检查工具 "📝 论文、语法、写作、英语等纠错检查工具")📝 论文、语法、写作、英语等纠错检查工具
...
## [](#🧾-Markdown-编辑器 "🧾 Markdown 编辑器")🧾 Markdown 编辑器
...
## [](#🐱‍🐉-免费查重网站包括 "🐱‍🐉 免费查重网站包括")**🐱‍🐉 免费查重网站包括**

1.  万方免费查重（应届生免费一次）：  
    [chsi.wanfangtech.net](chsi.wanfangtech.net)
...
7.  超星大雅（免费看相似度）：  
    [dsa.dayainfo.com](dsa.dayainfo.com)
8.  百度学术（免费使用PaperTime一次）：  
    [xueshu.baidu.com/usercenter/papercheck](xueshu.baidu.com/usercenter/papercheck)
...
## [](#🥡-在线学习、解题、搜题、答题网站及电报下载 "🥡 在线学习、解题、搜题、答题网站及电报下载")🥡 在线学习、解题、搜题、答题网站及电报下载
...
## [](#🏞-预览图生成器 "🏞 预览图生成器")🏞 预览图生成器

▎适合为博客文章生成适配 Twitter, Telegram 等媒介的预览图

1.  [https://pika.style/open-graph-generator](https://pika.style/open-graph-generator)
2.  [https://cards.microlink.io/editor](https://cards.microlink.io/editor)
3.  [https://poet.so/](https://poet.so/)
4.  [https://influencermarketinghub.com/instagram-ads-mockup/](https://influencermarketinghub.com/instagram-ads-mockup/)
5.  [https://influencermarketinghub.com/facebook-ads-mockup/](https://influencermarketinghub.com/facebook-ads-mockup/)
6.  [https://coverview.vercel.app/editor](https://coverview.vercel.app/editor)

## [](#🌈-渐变图 "🌈 渐变图")🌈 渐变图

1.  [http://color.oulu.me/](http://color.oulu.me/)
2.  [https://webkul.github.io/coolhue/](https://webkul.github.io/coolhue/)
3.  [https://uigradients.com/#GradeGrey](https://uigradients.com/#GradeGrey)
4.  [https://webgradients.com/](https://webgradients.com/)
5.  [https://gradient.shapefactory.co/](https://gradient.shapefactory.co/)

## [](#🎬-全球10大盗版片源BT网站 "🎬 全球10大盗版片源BT网站")🎬 全球10大盗版片源BT网站

⭐09-18

1.海盗湾：[https://thepiratebay.org/](https://thepiratebay.org/)

2.  1337X：[https://1337x.to/](https://1337x.to/)
3.  EZTV： [https://eztv.re/](https://eztv.re/)
4.  YTS： [https://yts.mx/](https://yts.mx/)
5.  RARBG: [https://rarbg.to/](https://rarbg.to/)  
    6.恶魔网：[https://www.demonoid.is/](https://www.demonoid.is/)
6.  Nyaa: [https://nyaa.si/](https://nyaa.si/)
7.  BT4G：[https://bt4g.org/](https://bt4g.org/)
8.  magnetDL： [https://www.magnetdl.com/](https://www.magnetdl.com/)
9.  Zooqle：[https://zooqle.com/](https://zooqle.com/)

•ETTV： [https://www.ettv.be/](https://www.ettv.be/)  
• GlotorRents:[http://glodls.to/](http://glodls.to/)  
•Torlock:[https://Torlock2.com](https://torlock2.com/)  
•ProxyBB：[http://proxybb.com/](http://proxybb.com/)  
•Edvok: [https://edvok.com/](https://edvok.com/)  
•动漫花园：[https://www.dmhy.org/](https://www.dmhy.org/)  
• Pirateiro [https://pirateiro.eu/](https://pirateiro.eu/)

## [](#🔔-文本语音AI "🔔 文本语音AI")🔔 文本语音AI
...
◾️【搜狗】智影-在线智能视频创作平台  
[https://zenvideo.qq.com/home](https://zenvideo.qq.com/home)
